...
class _WishListScreenState extends State<WishListScreen> {
  ...
  loadMoreData() {
    if (_controller.position.extentAfter < 50 ||
        wishListController.totalItem! >= wishListController.wishList.length) {
      wishListController.getWishListProduct();
    }
  }
  @override
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Wish List', style: TextTheme.of(context).headlineSmall),
        ),
                    ...
                    child: Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: ((BuildContext context, int index) {
                          ...
                          return FittedBox(
                            child: ProductCard(
                              id: wishListController.productId,
